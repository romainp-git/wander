class OpenaiService
  ...
  def get_prompt_activities_city(search)
    ...
    user_content = 
    "La destination de mon voyage est #{search.destination} du #{search.start_date} au #{search.end_date} et je recherche des activités appartenant aux catégories suivantes : Culturelle, Nature. Tu dois prendre en compte également ce besoin spécifique : Restaurant végétarien et une activité par jour spécifique pour des enfants."
