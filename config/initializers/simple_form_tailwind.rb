...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'relative' do |b|
    b.use :html5
    b.use :placeholder
    ...
    b.optional :min_max
    b.optional :readonly
    # input    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none   focus:outline-none focus:ring-0 focus:border-blue-600 peer"
    # label    class="absolute text-sm text-gray-500  duration-300 transform-translate-y-4 scale-75 top-2 z-10 origin-[0] bg-gray-800  px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1 rounded-md"
    #   placeholder:italic placeholder:text-slate-400
    b.use :input, class: 'block text-white bg-gray-800 shadow-sm py-3 w-full text-sm rounded-md border border-white appearance-none focus:outline-none focus:ring-1 focus:border-orange-500 focus:ring-orange-600 peer', error_class: 'border-red-500', valid_class: 'border-green-400'
    b.use :label, class: 'absolute text-sm text-gray-500 duration-300 transform-translate-y-4 scale-75 top-2 z-10 origin-[0] bg-gray-800  px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1 rounded-md', error_class: 'text-red-500'
